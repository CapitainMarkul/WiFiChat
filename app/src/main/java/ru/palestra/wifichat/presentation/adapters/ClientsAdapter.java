...
//        final LocalDateTime timeSend = TimeUtils.longToLocalDateTime(lastMessage.getTimeSend());
        ...
        if (client.isOnline()) {
            holder.itemView.setBackground(
                    ContextCompat.getDrawable(holder.context, R.drawable.client_online_background)
            );
        } else {
            holder.itemView.setBackground(
                    ContextCompat.getDrawable(holder.context, R.drawable.client_offline_background)
            );
        }
